{!! Form::open(array('url' => route('admin.colores.update', ':COLOUR_ID'), 'method' => 'PUT', 'name' => 'edit-delete-form', 'id' => 'edit-delete-form', 'class' => 'col-md-10 col-md-offset-1 form-horizontal szd-form', 'files' => true)) !!}
    <div class="row inputs">
        @include('admin.templates.partials.fields.colour')
        {!! Form::hidden('colour-id', null, ['id' => 'colour-id']) !!}
    ...
    <div class="row actions">
        ...
        {!! Form::close() !!}
        {!! Form::open(array('url' => route('admin.colores.destroy', ':COLOUR_ID'), 'method' => 'DELETE', 'name' => 'delete-form', 'id' => 'delete-form')) !!}
