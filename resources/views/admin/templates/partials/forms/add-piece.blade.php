{!! Form::open(array('url' => route('admin.piezas.store'), 'method' => 'POST', 'name' => 'add-form', 'id' => 'add-form', 'class' => 'col-md-10 col-md-offset-1 form-horizontal szd-form', 'files' => true)) !!}
